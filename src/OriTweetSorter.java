...
public class OriTweetSorter {
     ...
     */  
    public static class FirstPartitioner implements Partitioner<StrLongPair,Text>{  
	      @Override  
  ...
  public static class TweetMapper extends MapReduceBase 
  		implements Mapper<Object, Text, StrLongPair, Text> {
	...
	public void map(Object key, Text value,
			OutputCollector<StrLongPair, Text> output, Reporter reporter)
			throws IOException {
		...
		/*
		Long second = Long.parseLong(key.toString());
  	  	String line = value.toString();  
        int pos = line.indexOf("\t");
  ...
  public static class TweetReducer extends MapReduceBase 
       implements Reducer<StrLongPair, Text, Text, Text> {
	  private final Text newKey = new Text();  
	  private final Text newVal = new Text();
	  
	  @Override
      public void reduce(StrLongPair key, Iterator<Text> values,  
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (otherArgs.length != 2) {
      System.err.println("Usage: OriTweetSorter <indir> <outdir>");
      System.exit(2);
    }
    
    JobConf job = new JobConf(OriTweetSorter.class);
        
    job.setJarByClass(OriTweetSorter.class);//主类

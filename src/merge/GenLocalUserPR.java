...
public class GenLocalUserPR {

	public static HashMap<String, String> _globalUser2PRMap = new HashMap<String, String>();
	...
	public static boolean loadGlobalUserDictMap(String userDictFile) throws Exception {
		...
		while ((line = br.readLine()) != null) {
			...
			if (pos != -1) {
				_globalUser2PRMap.put(line.substring(0, pos), line.substring(pos+1));
			}
		}				
		br.close();	
	...
	public static void processFile(String srcFile, String dstFile) throws Exception{
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				String globalPR = _globalUser2PRMap.get(userStr);
				bw.write(userStr + "\t" + globalPR + "\n");
			}
		}
		finally {
			br.close();

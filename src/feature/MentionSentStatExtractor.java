...
public class MentionSentStatExtractor {	
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	 
              ...
              if (pos2 != -1) {
            	  ...
            	  long MentionCount = _parser.countMention(rest);            	            	  
                  context.write(newKey, new LongWritable(MentionCount));  
              }                            
          }  
      }  
  }
  ...
  public static class TweetReducer
      ...
      public void reduce(StrLongPair key, Iterable<LongWritable> values,  
          ...
          long totalMentionCount = 0;
          long totalTweetCount = 0;
    	 
    	  for (LongWritable val : values) {
        	  totalTweetCount ++;
    		  totalMentionCount += val.get();
          }    	  
    	  double avgMention = totalMentionCount / (double)totalTweetCount;
    	  newKey.set(key.getFirst());
    	  newVal.set(new Long(totalMentionCount).toString() + "\t" + new Double(avgMention).toString());
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(MentionSentStatExtractor.class);//主类

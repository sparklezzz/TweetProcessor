...
public class RetweetSentStatExtractor {	
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	 
              ...
              if (pos2 != -1) {
            	  ...
            	  boolean isRetweet = _parser.isRetweet(rest);
            	  long RetweetCount = isRetweet ? 1 : 0;            	            	  
                  context.write(newKey, new LongWritable(RetweetCount));  
              }                            
          }  
      }  
  }
  ...
  public static class TweetReducer
      ...
      public void reduce(StrLongPair key, Iterable<LongWritable> values,  
          ...
          long totalRetweetCount = 0;
          long totalTweetCount = 0;
    	 
    	  for (LongWritable val : values) {
        	  totalTweetCount ++;
    		  totalRetweetCount += val.get();
          }    	  
    	  double avgRetweet = totalRetweetCount / (double)totalTweetCount;
    	  newKey.set(key.getFirst());
    	  newVal.set(new Long(totalRetweetCount).toString() + "\t" + new Double(avgRetweet).toString());
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(RetweetSentStatExtractor.class);//主类

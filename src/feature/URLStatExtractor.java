...
public class URLStatExtractor {	
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	 
              ...
              if (pos2 != -1) {
            	  ...
            	  long urlCount = _parser.countURL(rest);            	            	  
                  context.write(newKey, new LongWritable(urlCount));  
              }                            
          }  
      }  
  }
  ...
  public static class TweetReducer
      ...
      public void reduce(StrLongPair key, Iterable<LongWritable> values,  
    	  ...
    	  for (LongWritable val : values) {
        	  totalTweetCount ++;
    		  totalURLCount += val.get();
          }    	  
    	  double avgURL = totalURLCount / (double)totalTweetCount;
    	  newKey.set(key.getFirst());
    	  newVal.set(new Long(totalURLCount).toString() + "\t" + new Double(avgURL).toString());
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(URLStatExtractor.class);//主类

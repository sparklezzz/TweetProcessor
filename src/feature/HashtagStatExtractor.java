...
public class HashtagStatExtractor {	
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	 
              ...
              if (pos2 != -1) {
            	  ...
            	  long hashtagCount = _parser.countHashtag(rest);            	            	  
                  context.write(newKey, new LongWritable(hashtagCount));  
              }                            
          }  
      }  
  }
  ...
  public static class TweetReducer
      ...
      public void reduce(StrLongPair key, Iterable<LongWritable> values,  
          ...
          long totalHashtagCount = 0;
          long totalTweetCount = 0;
    	 
    	  for (LongWritable val : values) {
        	  totalTweetCount ++;
    		  totalHashtagCount += val.get();
          }    	  
    	  double avgHashtag = totalHashtagCount / (double)totalTweetCount;
    	  newKey.set(key.getFirst());
    	  newVal.set(new Long(totalHashtagCount).toString() + "\t" + new Double(avgHashtag).toString());
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(HashtagStatExtractor.class);//主类

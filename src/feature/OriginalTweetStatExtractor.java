...
public class OriginalTweetStatExtractor {	
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	 
              ...
              if (pos2 != -1) {
            	  ...
            	  boolean isOriginal = _parser.isOriginalTweet(rest);
            	  long originalCount = isOriginal ? 1 : 0;            	            	  
                  context.write(newKey, new LongWritable(originalCount));  
              }                            
          }  
      }  
  }
  ...
  public static class TweetReducer
      ...
      public void reduce(StrLongPair key, Iterable<LongWritable> values,  
    	  ...
    	  for (LongWritable val : values) {
        	  totalTweetCount ++;
    		  totalOriginalCount += val.get();
          }    	  
    	  double avgOriginal = totalOriginalCount / (double)totalTweetCount;
    	  newKey.set(key.getFirst());
    	  newVal.set(new Long(totalOriginalCount).toString() + "\t" + new Double(avgOriginal).toString());
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(OriginalTweetStatExtractor.class);//主类

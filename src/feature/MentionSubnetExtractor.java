...
public class MentionSubnetExtractor {
	
	private static final String USER_MENTION_LINK_FILE = "user.mention.link.file";
  ...
  public static class TweetReducer
	  ...
	  @Override
		protected void setup(Context context
			...
			String userFileName = _conf.get(USER_MENTION_LINK_FILE);			
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(MentionSubnetExtractor.class);//主类
	...
	jconf.set(USER_MENTION_LINK_FILE, filename);

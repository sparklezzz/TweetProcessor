...
public class CharStatExtractor {	
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	 
              ...
              if (pos2 != -1) {
            	  ...
            	  long CharCount = _parser.countChar(rest);            	            	  
                  context.write(newKey, new LongWritable(CharCount));  
              }                            
          }  
      }  
  }
  ...
  public static class TweetReducer
	  ...
	  private ArrayList<Long> _tmpCCArr = new ArrayList<Long>();
      ...
      public void reduce(StrLongPair key, Iterable<LongWritable> values,  
          ...
          for (LongWritable val : values) {
        	  totalTweetCount ++;
    		  totalCharCount += val.get();
    		  _tmpCCArr.add(val.get());
          }    	  
    	  double avgChar = totalCharCount / (double)totalTweetCount;
    	  
    	  //calculate variance
    	  double variance = 0.0;
    	  for (long cc : _tmpCCArr) {
    		  double diff = cc - avgChar;
    		  variance += diff * diff;
    	  }
    	  variance /= totalTweetCount;
    	  
    	  newKey.set(key.getFirst());
    	  newVal.set(new Long(totalCharCount).toString() + "\t" + new Double(avgChar).toString()
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(CharStatExtractor.class);//主类

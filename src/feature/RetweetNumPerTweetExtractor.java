...
public class RetweetNumPerTweetExtractor {
  ...
  public static class TweetMapper
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	         	  
              ...
              if (pos2 != -1) {            	  
            	  String retweetUser = line.substring(pos + 1, pos2);
            	  if (! _userDict.contains(retweetUser)) {
            		  return;
            	  }  
            	  
            	  String rest = line.substring(pos2 + 1);
            	  String [] res = _parser.getOriginalPartFromRetweet(rest);
            	  if (res == null)
            		  return;
            	  ...
            	  Long second = MurmurHash.hash64(res[2]);
  ...
  public static class TweetReducer
      ...
      public void reduce(StrLongPair key, Iterable<Text> values,  
    	  ...
    	  for (Text val : values) {
        	  s = val.toString();        	  
        	  userName = key.getFirst();
        	  hash = key.getSecond();
        	  hasHash = true;
        	  count ++;        	          	          	
          }  
    	  
    	  if (s == null || userName == null || !hasHash)
    		  return;
    	  
    	  newKey.set(key.getFirst());
    	  newVal.set(new Long(key.getSecond()).toString() + "\t"
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(RetweetNumPerTweetExtractor.class);//主类
    ...
    // 分组函数
    // Here we group fingerprint in each user, not user

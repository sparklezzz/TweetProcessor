...
public class CountUser {
  ...
  public static class TweetReducer
       extends Reducer<StrLongPair, Text, Text, LongWritable> {
      ...
      public void reduce(StrLongPair key, Iterable<Text> values,  
    	  ...
    	  if (count >= _minTweetNum) {
    		  ...
    		  context.write(newKey, new LongWritable(count));
    	  }
      }     
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (otherArgs.length != 3) {
      System.err.println("Usage: CountUser <min-tweet-num> <indir> <outdir>");
      System.exit(2);
    }
    ...
    job.setJarByClass(CountUser.class);//主类

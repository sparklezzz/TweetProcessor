package util;
    /*  
       ...
       See also http://www.tartarus.org/~martin/PluralRemovalStemmer  
    ...
    */   
    ...
    public class PluralRemovalStemmer   
    {  private char[] b;   
       ...
       public void set(String str) {
    	   ...
    	   if (i + str.length() > b.length) {
    		   char[] new_b = new char[i + str.length() + INC];    		
    		   b = new_b;
    	   }
       ...
       public void set(StringBuffer strbuf) {
    	   
    	   if (i + strbuf.length() > b.length) {
    		   char[] new_b = new char[i + strbuf.length() + INC];    		
    		   b = new_b;
    	   }
    	   for (int c = 0; c < strbuf.length(); c++) {
    		   b[i++] = strbuf.charAt(c);
    	   }
       ...
       */   
       ...
       {   
          char[] w=new char[501];   
          PluralRemovalStemmer s = new PluralRemovalStemmer();   

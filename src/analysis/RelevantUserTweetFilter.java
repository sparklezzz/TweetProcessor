...
public class RelevantUserTweetFilter {

	private static final String USER_NAME = "relevant.user.name";
      ...
      public void map(Object key, Text value, Context context)  
          ...
          if (pos != -1) {          	 
              ...
              if (pos2 != -1) {
                  ...
                  if (!first.equals(_userName) && !_parser.ContainsUserName(rest, _userName)) {
                	  return;
                  }                                
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (otherArgs.length != 3) {
      System.err.println("Usage: " + className + " <username> <indir> <outdir>");
      System.exit(2);
    }
    ...
    job.setJarByClass(RelevantUserTweetFilter.class);//主类
    ...
    job.getConfiguration().set(USER_NAME, otherArgs[0].trim().toLowerCase());
